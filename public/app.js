...
async function enterApp(offline = false) {
  ...
  await refresh(); if(location.hash.startsWith('#chat')){showView('chat',false);return;} history.replaceState({ view: 'tasks' }, '', '#tasks'); showView('tasks', false);
}
